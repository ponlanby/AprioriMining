...
public class apriori2 {
	...
	public Map<String, Integer> apriori(ArrayList<String> dataList) {
		Map<String, Integer> stepFrequentSetMap = new HashMap<>();//候选项集
	...
	public static void main(String[] args) throws Exception {
		...
		String sql = "select search_word1,search_word2,search_word3,search_word4,weight from `weighted_trajectory` limit 0, 300";
...
//		String sql = "select search_word1,search_word2,search_word3,search_word4,weight from `weighted_trajectory` where category='Agriculture & Food'";
